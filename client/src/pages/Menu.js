...
const Menu = () => {
  ...
  const categories = [
    ...
    { id: 'Захиалгат хоол', name: 'Захиалгат хоол' },
    { id: 'Иж бүрдэл хоол', name: 'Иж бүрдэл хоол' },
    { id: 'Багц хоол', name: 'Багц хоол' },
    { id: 'Сет хоол', name: 'Сет хоол' },
    { id: 'Ширхэгийн хоол', name: 'Ширхэгийн хоол' },
    { id: 'Зууш', name: 'Зууш' },
    { id: 'Ус Ундаа', name: 'Ус Ундаа' }
  ];
